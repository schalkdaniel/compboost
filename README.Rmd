...
For convenient possibility to tune `compboost`, a [`mlr3`](https://github.com/mlr-org/mlr3) learner is included in this package. Furthermore, the tuning can be easily done using the [`mlr3tuningspaces`](https://github.com/mlr-org/mlr3tuningspaces) package:
