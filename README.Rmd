...
For convenient possibility to tune `compboost`, a mlr3 learner is included in this package. Furthermore, the tuning can be easily done using the `mlr3tuningspaces` package:
