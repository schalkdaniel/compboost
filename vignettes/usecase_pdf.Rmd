...
3. Write the design matrix and other permanent data into the data source object.
...
```{r, warning=FALSE, fig.align="center", fig.width=7, fig.height=4.6, , out.width="0.8\\textwidth"}
library(ggplot2)
...
```{r, message=FALSE, warning=FALSE, fig.align="center", fig.width=12, fig.height=4, , out.width="0.8\\textwidth"}
auc.data = data.frame(
...
```{r, message=FALSE, warning=FALSE, fig.align="center", fig.width=7, fig.height=4.6, out.width="0.8\\textwidth"}
params = cboost$getEstimatedParameter()
