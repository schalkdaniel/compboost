---
title: "Reference based objects"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Reference based objects}
...
In the case of binary classification, we can use the response object to calculate the predictions on a label basis by using a specified threshold $a$:
$$
...
This behavior has nothing to do with references at the moment. During the fitting of a component-wise boosting model, these predictions are adjusted over and over again by the `Compboost` object. This is where the reference comes in:
```{r}
