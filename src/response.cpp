...
ResponseBinaryClassif::ResponseBinaryClassif (const std::string& _target_name, const std::string& _pos_class, 
...
ResponseBinaryClassif::ResponseBinaryClassif (const std::string& _target_name, const std::string& _pos_class, 
  const std::vector<std::string>& _response, const arma::mat& _weights)
{
